...
<table border="1">
	...
	<tr>
		<td><a href="/srping/board/detail.do?boardno=${vo.boardno }">${vo.boardno }</a></td>		
		<td><a href="/srping/board/detail.do?boardno=${vo.boardno }">${vo.title }</a></td>		
		<td><a href="/srping/board/detail.do?boardno=${vo.boardno }">${vo.writer }</a></td>		
		<td><a href="/srping/board/detail.do?boardno=${vo.boardno }">${vo.regdate }</a></td>		
	</tr>	
	</c:forEach>	
</table>
